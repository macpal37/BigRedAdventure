...
let rec run_tick _ =
  ...
  DrawText.draw_string_colored 255 166 DrawText.Small "yeet" Draw.white
    Draw.text_color ();
  DrawText.draw_string_colored 255 270 DrawText.Small "yeet" Draw.white
    Draw.text_color ();
  DrawText.draw_string_colored 255 374 DrawText.Small "yeet" Draw.white
    Draw.text_color ();
